...
#pragma multi_compile _ _ENABLE_CFF
...
#else
	#define CFF_POS_COORDS(idx)
	#define CFF_TRANSFER_POS(o)
	#define CFF_PARAM_DECLARATION
	#define CFF_CALL_PARAMETER
	#define COLOR_FIELD_FUNCTION(color)
	#define COLOR_FIELD_FUNCTION_VERTEX(color)
	#define COLOR_FIELD_FUNCTION_MANUAL_POS(color, pos)
#endif
